...
SOURCE_COMPILER = $(SOURCE)wizard-basic-4/
...
OBJECTS = \
	...
	$(SOURCE_COMPILER)DeclareFunctionStatement.o \
	...
	$(SOURCE_COMPILER_EXCEPTIONS)InvalidFunctionIdentifier.o \
...
main: $(OBJECTS)
	mkdir -p $(BUILD)
	$(CXX) $(CXXFLAGS) -o $(BUILD)wb4 $(OBJECTS) $(LDFLAGS)
